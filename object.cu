...
#ifndef _OBJECT_DEVICE
#define _OBJECT_DEVICE

typedef unsigned int Object;

/************************************/
/* Functions about object in device */

__device__ inline Object setObject(char var,short int i,short int j) {
	unsigned int o=0;
    	o=(var)<<24;
    	o=o|((i)<<8);
    	o=o|(j&0xFF);
...
__device__ inline Object setVar(Object o, char var) {
	return o=(o&0xFFFFFF)|(var)<<24;
}

__device__ inline Object setJ(Object o, short int j) {
	return (o&0xFFFFFF00)|(j&0xFF);
}
...
__device__ inline short int getI(Object o) {
    	return (short int) ((o>>8)&0xFFFF);
}

__device__ inline short int getJ(Object o) {
    	return (short int) (o&0xFF);
}
